...
def the_following_bindings_rules_are_available(step, operation_rule_index):
    api_utils.the_following_bindings_rules_are_avalilabe(step, operation_rule_index)
